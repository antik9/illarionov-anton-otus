    ...
    if ( acc.length == 0 ) {
        ...
        return function(...extra) {
            if ( extra.length == 0 ) {
                ...
                console.error("Different types of arguements")
                return undefined;
            }
...
console.assert(sum(1, 2) === undefined, "two or mote arguments not allowed")
console.assert(sum(1)("a") === undefined, "different types are not allowed")
console.assert(sum({}) === undefined, "bad argument allowed")